...
class MenuFoodEdit extends Component{
  constructor(props){
    super(props);
...
handleChange(e){
  ...
  onSubmit(e){
      ...
      axios.put(`http://192.168.5.224:5000/api/warung/food/${this.props.props.match.params.id}`, obj)
  ...
  componentDidMount() {
    ...
    axios.get(`http://192.168.5.224:5000/api/warung/food/${this.props.props.match.params.id}`)
      .then(res => {
    ...
    render(){
      ...
      <div className="isi">
            ...
            <div className="addF">
                <div className="saip">
                <img className="edtfoodimg" src={edit}/>
                <img className="imgaddfd2" src={food}/>
