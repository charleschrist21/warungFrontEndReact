...
class MenuDrinkAdd extends Component{
    constructor(props){
        super(props);
    ...
    handleChange(e){
      ...
      onSubmit(e){
          ...
          axios.post('http://192.168.5.224:5000/api/warung/drink', obj)
    ...
    render(){
        return(
            ...
            <div className="formAddFood">
                <img src={drink} className="icdrinkEdit"/>
                <img src={plus} className="icplusdrinkEdit"/>
                 <div className="saip">
